...
> Note: This topic is optional. The azd tool is a workflow layer on top of Bicep and Terraform, so teams that already provision with those tools directly can move straight to [Bicep Infrastructure Templates](../04-bicep/).
