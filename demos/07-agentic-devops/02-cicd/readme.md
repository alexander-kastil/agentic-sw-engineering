...
Read demos/07-agentic-devops/01-iac for the infrastructure layout before writing the YAML.
```
...
[GitHub Actions documentation](https://docs.github.com/en/actions) - workflow syntax, triggers, and the job and step model the demo prompts build on

[Use secrets in GitHub Actions](https://docs.github.com/en/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets) - how the secrets context resolves and where masking stops working

[gh secret manual](https://cli.github.com/manual/gh_secret) - every flag the `gh secret set` and `gh secret list` commands accept

[Secure use reference](https://docs.github.com/en/actions/reference/security/secure-use) - least-privilege tokens, action pinning, and the risks the demo prompt asks the agent to address

[← Previous: IaC & Configuration](../01-iac/readme.md) | [Back to Agentic DevOps](../readme.md) | [Next: Testing using Copilot →](../03-testing/readme.md)
