...
public static class StudentTools
{
  ...
  [Description("Retrieves the age of a specific student identified by their full name (case-insensitive). Returns null if student is not found.")]
  ...
  [Description("Retrieves a list of all students enrolled in a specific school (case-insensitive). Returns the students as a JSON string, or null if no students are found.")]
  ...
  [Description("Identifies the school with either the highest or lowest student enrollment and returns information about its student count.")]
  public static string? GetSchoolWithMostOrLeastStudents(
  ...
  [Description("Retrieves all students grouped by their school, sorted by enrollment count in descending order. Returns the data as a JSON string.")]
  public static string? GetStudentsInSchool()
  {
