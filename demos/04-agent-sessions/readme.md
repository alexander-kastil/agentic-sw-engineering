...
| [Deep Research with /research](./06-research/) | Run the read-only research agent and judge the cited Markdown report it produces. |
| [Troubleshooting Agent Sessions](./07-troubleshooting/) | Diagnose local and remote agent-host sessions with /troubleshoot. |
| [A Second Opinion with /rubber-duck](./08-rubber-duck/) | Hand a finished run to a complementary model and read what it says was missed. |
...
| `/rubber-duck` | Get a second opinion on the current session from a complementary model, without changing any code |
...
- [Deep Research with /research](./06-research/)
- [Troubleshooting Agent Sessions](./07-troubleshooting/)
- [A Second Opinion with /rubber-duck](./08-rubber-duck/)
