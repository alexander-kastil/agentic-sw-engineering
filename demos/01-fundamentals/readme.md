...
| Topic                                                      | Description                                                                                                               |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| **[GitHub Copilot Introduction](./01-intro/)**             | Get started with Copilot capabilities, AI Assisted vs. Agentic modes, Copilot Vision, and key resources for VS Code and GitHub workflows. |
| **[Selecting Models](./02-models/)**                       | Compare available Copilot models and choose the best fit by context size, cost, and task.                                 |
...
| **[Working in the Terminal](./08-terminal/)**              | Understand machine-readable agent output via the VSCODE_AGENT variable and terminal output compression for test runners, builds, and linters. |
