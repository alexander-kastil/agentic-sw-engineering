...
A reference solution is checked in at [devops-solution/](devops-solution/readme.md). Your own run of this exercise still produces the same changes in your own cloned ContosoShopEasy repository; the solution folder is there to compare against, not to copy from.
...
1. Take a minute to find the following security issues:
    ...
    - Locate the DisplayKnownVulnerabilities method and review the comments describing security vulnerabilities. This code is related to the "Reduce Information Disclosure in Error Messages (Console Output)" issue.
...
1. Make a list of the code files related to the issues assigned to you.
    ...
    - Models/Order.cs/PaymentInfo class
