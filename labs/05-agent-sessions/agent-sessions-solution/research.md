...
One folder per sample project sits directly under `src/`. There are nine of them: `src/angular`, `src/copilot-api`, `src/copilot-api-ui`, `src/doubler-api`, `src/food-app`, `src/hr-mcp-server`, `src/qr-server`, `src/qr-server-cs`, `src/react`.
...
- `src/qr-server/requirements.txt` next to `src/qr-server/server.py`
...
|--------------|----------|-----------------|
| Python, pinned requirements | `requirements.txt` | `src/qr-server/requirements.txt` |
