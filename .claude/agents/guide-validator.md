...
You receive one absolute path to a `demos/**/demo-NN-*.md` file. Read `.claude/skills/brand-voice-cowork/references/rules.md` and `.claude/skills/create-class/references/author-guide.md` once. Apply every rule to the file in a single edit. Return a one-line report:
