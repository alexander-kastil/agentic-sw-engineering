...
one deck. Invoke [merge-slides.md](merge-slides.md) when:
...
[edit-existing-pptx.md](edit-existing-pptx.md), which carries the
...
fidelity, follow [merge-slides.md](merge-slides.md) (PowerPoint COM
